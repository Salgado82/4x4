...
//$base_url="http://desarrollo.inez-inez.com"; //url base of site if you want only relative url leave empty
//$upload_dir = '/cms/media/'; // path from base_url to upload base dir
//$current_path = '../../../../../../cms/media/'; // relative path from filemanager folder to upload files folder

$base_url="http://localhost"; //url base of site if you want only relative url leave empty
$upload_dir = '/cms/tinymce/js/source/'; // path from base_url to upload base dir
$current_path = '../../../source/'; // relative path from filem
